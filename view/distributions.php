	 ...
	 <div class="main">
	 	<div class='container content_top'>
	 		<div class="row">
		  		  ...
		  		  <div class="col-md-12">
		  		   <h3 class="m_2">Distributions</h3>
		  		   <div class="list styled custom-list">
					<ul>
						<li><span class="dropcap">1</span>  <h5><a href="?distributions=fedora">Fedora</a></h5> <p> anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima. Eodem modo typi, qui nunc nobis videntur paru.</p></li>
